...
if (phones && Array.isArray(phones)) {
  phones.forEach((item, index) => {
    Output.innerHTML += `
      <div class="cards">
        <img src="https://www.apple.com/newsroom/images/product/iphone/standard/Apple_iPhone-13-Pro_iPhone-13-Pro-Max_09142021_inline.jpg.large_2x.jpg" alt="Model ${item.brand} ${item.model}" class="card-image" />
